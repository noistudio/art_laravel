$('head').append("<style>.ce-header{padding:1em 0;margin:0;margin-bottom:-.9em;line-height:1.5em;outline:0}.ce-header div,.ce-header p{padding:0!important;margin:0!important}.ce-header[contentEditable=true][data-placeholder]::before{position:absolute;content:attr(data-placeholder);color:#707684;font-weight:400;display:none}.ce-header[contentEditable=true][data-placeholder]:empty::before{display:block}.ce-header[contentEditable=true][data-placeholder]:empty:focus::before{display:none}</style>");
/**
