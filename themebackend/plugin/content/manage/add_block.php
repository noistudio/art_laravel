...
<table class="table">
    <tr>
        <td><?php echo __("backend/content.call_with_dynamic_params"); ?></td>
...
<table class="table">
    <tr>
        ...
        <td>
            <select name="{param}[order_field]" class="form-control">
                <option value="arrow_sort"><?php echo __("backend/content.sort_pos") ?></option> 
                <?php
                if (count($fields)) {
    ...
    <tr>
        <td><?php echo __("backend/content.type_sort") ?> </td>
        <td>
...
<table class="table">
    ...
    <tr>
        ...
        <td><?php echo __("backend/content.max_limit") ?> </td>
        <td></td>
                ...
                <tr>
                    ...
                    <td>
                        <select class="form-control" name="{param}[type_<?php echo $field['name']; ?>]">
                            <option <?php
                            if (isset($params['fields'][$field['name']]['type_op']) and $params['fields'][$field['name']]['type_op'] == "=") {
                                echo 'selected';
                            }
                            ?> value='='><?php echo __("backend/content.op_=") ?></option>
                            <option <?php
                            if (isset($params['fields'][$field['name']]['type_op']) and $params['fields'][$field['name']]['type_op'] == "LIKE") {
                                echo 'selected';
                            }
