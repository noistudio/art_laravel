...
Vvveb.Components.add("components/product", {
    ...
    image: "/themeadmin/name/builder_js/libs/builder/icons/map.svg",
...
Vvveb.Components.add("components/products", {
    ...
    image: "/themeadmin/name/builder_js/libs/builder/icons/products.svg",
...
Vvveb.Components.add("components/manufacturers", {
    ...
    image: "/themeadmin/name/builder_js/libs/builder/icons/categories.svg",
    html: '<div class="form-group"><label>Your response:</label><textarea class="form-control"></textarea></div>',
    properties: [{
        nolabel:false,
        inputtype: TextInput,
...
Vvveb.Components.add("components/search", {
    ...
    image: "/themeadmin/name/builder_js/libs/builder/icons/search.svg",
    html: '<div class="form-group"><label>Your response:</label><textarea class="form-control"></textarea></div>',
    properties: [{
        name: "asdasdad",
        key: "src",
...
Vvveb.Components.add("components/user", {
    ...
    image: "/themeadmin/name/builder_js/libs/builder/icons/user.svg",
    html: '<div class="form-group"><label>Your response:</label><textarea class="form-control"></textarea></div>',
    properties: [{
        name: "asdasdad",
        key: "src",
...
Vvveb.Components.add("components/product_gallery", {
    ...
    image: "/themeadmin/name/builder_js/libs/builder/icons/product_gallery.svg",
    html: '<div class="form-group"><label>Your response:</label><textarea class="form-control"></textarea></div>',
    properties: [{
        name: "asdasdad",
        key: "src",
...
Vvveb.Components.add("components/cart", {
    ...
    image: "/themeadmin/name/builder_js/libs/builder/icons/cart.svg",
    html: '<div class="form-group"><label>Your response:</label><textarea class="form-control"></textarea></div>',
    properties: [{
        name: "asdasdad",
        key: "src",
...
Vvveb.Components.add("components/checkout", {
    ...
    image: "/themeadmin/name/builder_js/libs/builder/icons/checkout.svg",
    html: '<div class="form-group"><label>Your response:</label><textarea class="form-control"></textarea></div>',
    properties: [{
        name: "asdasdad",
        key: "src",
...
Vvveb.Components.add("components/filters", {
    ...
    image: "/themeadmin/name/builder_js/libs/builder/icons/filters.svg",
    html: '<div class="form-group"><label>Your response:</label><textarea class="form-control"></textarea></div>',
    properties: [{
        name: "asdasdad",
        key: "src",
...
Vvveb.Components.add("components/product", {
    ...
    image: "/themeadmin/name/builder_js/libs/builder/icons/product.svg",
    html: '<div class="form-group"><label>Your response:</label><textarea class="form-control"></textarea></div>',
    properties: [{
        name: "asdasdad",
        key: "src",
...
Vvveb.Components.add("components/slider", {
    ...
    image: "/themeadmin/name/builder_js/libs/builder/icons/slider.svg",
    html: '<div class="form-group"><label>Your response:</label><textarea class="form-control"></textarea></div>',
    properties: [{
        name: "asdasdad",
        key: "src",
