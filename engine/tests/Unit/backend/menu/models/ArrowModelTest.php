...
class ArrowModelTest extends TestCase {
    ...
    public function testUp() {
        \menu\models\ArrowModel::up($this->menu['id'], 1);
    }

    public function testDown() {
        \menu\models\ArrowModel::up($this->menu['id'], 0);
    }

    public function testGetLinks() {
        \menu\models\ArrowModel::getLinks($this->menu['links'], 0, array(1), "down");
        \menu\models\ArrowModel::getLinks($this->menu['links'], 0, array(1), "up");
    }
